...
# -----------------------------------------------------------------------------
# Title: train-multimodal.py
#
# Description: This script trains a ResNet18 model to predict fish ages using
# fish scale images and associated metadata (fish length, weight, and month of
# catch). Arguments, hyperparameters, and other settings are included in a
# configurations.yml file. The trained model is saved to a specified output
# directory.
#
...
#
# Usage: python train-multimodal.py -c path/to/configurations.yml
# -----------------------------------------------------------------------------
