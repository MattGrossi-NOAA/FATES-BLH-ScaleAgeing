...
python Scale_Aging_Inference_Script_Multimodal.py --config_path configuration-2024-atl.yml
```
...
python Scale_Aging_Inference_Script_Image_Only.py --config_path "c:/Users/user.name/Documents/data/2024/configurations.yml"
```
