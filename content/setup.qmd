...
The model code and most of its dependencies are [available on GitHub]({{< meta website.repo-url >}}). To retrieve it, clone the `scales` branch of this repo, which is currently functioning as the production version of the model:
...
2. Clone the repository into the desired directory
   ...
   ```bash
   git clone -b scales {{< meta website.repo-url >}} .
   ```
