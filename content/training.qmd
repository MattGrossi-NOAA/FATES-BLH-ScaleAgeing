...
Both of these scripts will write out a new model weights file called `best_model.pth` which corresponds to the best-performing version of the model obtained during the training loop. Simply rename this file something more intuitive and use it as described in [Using the Model](usage.qmd).